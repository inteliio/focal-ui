      ...
      <div className="container">
        <div className="mb-9 flex flex-col items-start justify-center gap-x-10 gap-y-4 md:flex-row lg:mb-16 lg:justify-between">
          ...
          <div className="w-full md:max-w-72 md:self-end lg:max-w-[470px]">
            <TextAppearAnimation>
              <p className="text-appear max-w-lg md:place-self-end md:text-right">Our user-centered design encourages productivity and boosts revenue.</p>
            </TextAppearAnimation>
                ...
                <figure className="relative">
                  <Link href={`/communication-agency/blog/${story.slug}`}>
                    <div className="relative">
                      <img src={story?.thumbnail} alt={`Success Story - ${story?.title}`} width={400} height={300} className="h-auto w-full" />
