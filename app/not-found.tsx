      ...
      <section className="relative h-screen overflow-hidden pt-36 md:pt-12 lg:pt-0 2xl:pt-12">
        ...
        <div className="container">
          <RevealWrapper className="flex flex-col items-center justify-center">
            ...
            <h2 className="mb-8 mt-8 text-[36px] font-normal leading-[1.1] max-lg:leading-[1.33] md:mb-[50px] lg:text-[87px] lg:tracking-[-2.83px]">Page not Found</h2>
            <Link href="/" className="rv-button rv-button-secondary">
